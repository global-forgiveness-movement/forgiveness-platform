...
const GATE_CSS = `
.gate{position:fixed;inset:0;z-index:50;display:grid;place-items:center;background:#f4efe3;padding:1.5rem;
...
.gate-card .script{font-family:'Sacramento','Snell Roundhand',cursive;font-size:2.1rem;color:#0f6659;line-height:1.1;display:block}
.gate-card h1{font-family:'Poppins','Trebuchet MS',sans-serif;font-size:1.35rem;color:#123b53;margin:0.2rem 0 0.4rem}
.gate-card p{font-size:0.92rem;color:rgba(36,51,62,0.66);margin:0 auto 1.2rem}
.gate-card form{display:flex;gap:0.5rem}
.gate-card input{flex:1;border:1.5px solid rgba(18,59,83,0.14);border-radius:999px;background:#fffdf7;padding:0.65rem 1.1rem;font-size:1rem;font-family:inherit}
.gate-card input:focus{border-color:#1b7f72;outline:none}
.gate-card button{border:0;border-radius:999px;background:#1b7f72;color:#fff;font-family:'Poppins',sans-serif;
  font-weight:600;font-size:0.98rem;padding:0.75rem 1.5rem;cursor:pointer}
.gate-err{color:#7e3a67;font-size:0.88rem;min-height:1.4em;margin-top:0.6rem}
